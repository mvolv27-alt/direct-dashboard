  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-lg w-9 font-semibold text-[0.8rem]",
        ...
        day_selected:
          "gradient-primary text-primary-foreground shadow-[0_6px_16px_hsl(var(--primary)/0.22)] hover:text-primary-foreground focus:text-primary-foreground",
